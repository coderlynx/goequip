    ...
    while (($row = $stmt->fetch(PDO::FETCH_ASSOC)) !== false) {
       ...
       if ($row["cantidad"] == 0) {
          ...
          $mensaje_cliente = "Estimado " + data['payer']['first_name'] + ' ' + data['payer']['last_name'] + ',<br/><br/> 
            ...
            $mensaje_duenio = "Has concretado una venta pendiente.<br /><br />El cliente " + data['payer']['first_name'] + ' ' + data['payer']['last_name'] + ', ha realizado el pago por un total de $ ' + data['payer']['transaction_amount'] + ' del pedido número ' + data['id'] + ' que se encontraba pendiente.<br />El estado del pago es: ' + data['status'] + '.';
